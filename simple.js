    ...
    return await conn.sendMessage(jid, {
      ...
      */
      ...
      async value(image, width, height) {
       let length = await Jimp.read(image)
       let res = await oyy.resize(width, height).getBufferAsync(Jimp.MIME_JPEG)
       return res
      }
    },
    /** Profile Image
        ...
        quoted: {
            get() {
                ...
                return Object.defineProperties(JSON.parse(JSON.stringify(typeof q === 'string' ? { text: q } : q)), {
                    ...
                    mentionedJid: {
                        get() {
                            return m.quoted.contextInfo?.mentionedJid?.length && m.quoted.contextInfo.mentionedJid || []
                        },
                        enumerable: true
                    },
                    name: {
